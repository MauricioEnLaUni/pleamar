...
const featMsg = "VisitorHome.features.list.";
const tstMsg = "VisitorHome.testimonials.";
        ...
        <Grid container>
            ...
            <Grid container className="mt-8 flex mx-auto">
                ...
                <Grid xs={6}>
                    <Stack className="pr-12">
                        <LocalizedText excerpt={`${ featMsg }feat0`} style={"mt-3 max-w-xs text-lg"} />
                        <LocalizedText excerpt={`${ featMsg }feat1`} style={"mt-24 max-w-xs text-lg"} />
                    </Stack>
                </Grid>
                <Grid xs={6} className="pl-12">
                    <LocalizedText excerpt={`${ featMsg }feat2`} style={"mt-16 max-w-xs text-lg"} />
                </Grid>
            </Grid>
            ...
            <Grid>
                <Stack className="mx-auto w-7/12 my-16">
                    ...
                    <Stack direction="row">
                        { testimonials.map(e => (
                            <LocalizedText key={`testimonials.${ e }`} excerpt={`${ tstMsg }${ e }`} />
                        ))}
                    </Stack>
                </Stack>
            </Grid>
